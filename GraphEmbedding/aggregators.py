...
from GraphEmbedding.layers import Layer, Dense
from GraphEmbedding.inits import glorot, zeros
...
class MeanAggregator(Layer):
    ...
    def _call(self, inputs):
        ...
        neigh_vecs = tf.nn.dropout(neigh_vecs, 1-self.dropout) #(-1,node_sample,106)
        self_vecs = tf.nn.dropout(self_vecs, 1-self.dropout)  
        neigh_means = tf.reduce_mean(neigh_vecs, axis=1) # all neighbors mean (-1,106)
