...
# val_data = utils.prepare_eval_test(val_data,user_grid.keys(), batch_size= args.batch_size,n_qitems=args.qitems, n_items=n_items )
...
val_sampler = sampler.Sampler(
    ...
    batch_size = args.batch_size,
    n_qitems = args.qitems,
    neg_size= args.list_size*50-1,
    n_workers=args.worker,
    neg_method='rand'
)
checkpoint_dir = '_'.join(['./model/q_doc',str(args.embsize), str(args.list_size), str(args.qitems)])
