...
parser.add_argument('--embsize', type=int, default=256, help='dimension of item embedding (default: 100)')
...
parser.add_argument('--batch_size', type=int, default= 50, help='batch size (default: 128)')
parser.add_argument('--seq_len', type=int, default= 25, help='max sequence length (default: 20)')
parser.add_argument('--qitems', type=int, default=3, help='max num query items (default: 5)')
parser.add_argument('--list_size', type=int, default= 2, help='number of docs for each query (default: 2)')
parser.add_argument('--worker', type=int, default= 2, help='number of sampling workers (default: 10)')
